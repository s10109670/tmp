...
<link rel="shortcut icon" href="${applicationScope.appConfig.logoBase64 }" type="image/x-icon" />
<link rel="icon" href="${applicationScope.appConfig.logoBase64 }" type="image/x-icon" />
<!-- <Bootstrap CDN>  -->
...
<link href="https://maxcdn.bootstrapcdn.com/bootstrap/3.3.7/css/bootstrap.min.css" rel="stylesheet"> 
 -->
<link rel="stylesheet"
	href="${pageContext.request.contextPath}/jscripts/bootstrap-3.3.7-dist/css/bootstrap.min.css?ver=1">
...
<link
	href="${pageContext.request.contextPath}/jscripts/bootstrap-flat-3.3.4-dist/docs.min.css?ver=1"
	rel="stylesheet">
<link
